...
class T03 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_t03)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main)) { v, insets ->
            val systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars())
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom)
            insets
        }
        tvtitle = findViewById(R.id.T03TVTITLE)
        tvtitle.text = intent.getStringExtra("Desc").toString()
        btnMenu = findViewById(R.id.T03btnMenu)
        btnClear = findViewById(R.id.T03btnClear)
        btnSave = findViewById(R.id.T03btnSave)
        barcodeED = findViewById(R.id.T03EDBarcode)
        partED = findViewById(R.id.T03EDPart)
        uomED = findViewById(R.id.T03EDUOM)
        qtyED = findViewById(R.id.T03EDQty)
        lotNoED = findViewById(R.id.T03EDLotNo)
        fromLoc = findViewById(R.id.T03EDFromLoc)
        toLoc = findViewById(R.id.T03EDToLoc)
        PB = findViewById(R.id.T03PB)
        TVPrefLoc = findViewById(R.id.T03TVPreferedLoc)
    ...
    private suspend fun sendtoSAP():String{
        var result = String()
        withContext(Dispatchers.IO){
            val url = URL("http://172.16.206.19/BARCODEWEBAPI/api/MPQT03")
